...
const ScrollStack = ({
  ...
  const containerClassName = useWindowScroll
    ...
    : `relative w-full h-full overflow-y-auto overflow-x-visible items-scroll-container [&::-webkit-scrollbar]:hidden ${className}`.trim();

  return (
    <div className={containerClassName} ref={scrollerRef} style={containerStyles}>
      <div className="scroll-stack-inner pt-6 px-4 pb-[20rem] min-h-[120vh]">
        {children}
